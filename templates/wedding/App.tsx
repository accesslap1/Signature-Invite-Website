// Single-file Figma Make version: all invitation media assets are embedded as data URIs.
// No local image/video/audio files are required. Google Fonts remain web-loaded by the CSS.
import React, { FormEvent, useEffect, useMemo, useRef, useState } from 'react';

const ASSETS: Record<string, string> = {
  'wedding-card.mp4': '/media/wedding/wedding-card.mp4',
  'envelope-first.webp': '/media/wedding/envelope-first.webp',
  'bouquet.webp': '/media/wedding/bouquet.webp',
  'hands.webp': '/media/wedding/hands.webp',
  'reception-table.webp': '/media/wedding/reception-table.webp',
  'hero.webp': '/media/wedding/hero.webp',
  'wedding-car.webp': '/media/wedding/wedding-car.webp',
  'contact-frank.webp': '/media/wedding/contact-frank.webp',
  'closing.webp': '/media/wedding/closing.webp',
  'couple-portrait.webp': '/media/wedding/couple-portrait.webp',
  'wine-toast.webp': '/media/wedding/wine-toast.webp',
  'marry-you.mp3': '/media/wedding/marry-you.mp3',
  'celebration.webp': '/media/wedding/celebration.webp',
};
